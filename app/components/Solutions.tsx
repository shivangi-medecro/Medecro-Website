  ...
  return (
    <div className="w-full py-20 font-outfit" style={{
      ...
      <div className="container mx-auto px-4 max-w-6xl 2xl:max-w-[76rem] ">
        ...
        {/* Subheading */}
        <p className="text-center text-gray-700 max-w-[33rem] 2xl:max-w-[38rem] mx-auto mb-16 text-sm 2xl:text-base">
        ...
        {/* Features Grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-0 max-w-[64rem] 2xl:max-w-[90rem] mx-auto">
          {/* Feature 1 */}
          <div className="flex flex-col items-center text-center px-6 relative">
            <Image
              ...
              className="mb-4"
            />
            <h3 className="text-lg 2xl:text-xl font-medium mb-2 w-40">Timely Disease Recognition</h3>
            <p className="text-gray-600 mb-4 text-xs 2xl:text-sm">
          ...
          <div className="flex flex-col items-center text-center px-6 relative">
            <Image
              ...
              className="mb-4"
            />
            <h3 className="text-lg 2xl:text-xl font-medium mb-2 w-40">Seamless Integration</h3>
            <p className="text-gray-600 mb-4 text-xs 2xl:text-sm">
          ...
          <div className="flex flex-col items-center text-center px-6 relative">
            <Image
              ...
              className="mb-4"
            />
            <h3 className="text-lg 2xl:text-xl font-medium mb-2 w-40">Patient-Centric Innovation</h3>
            <p className="text-gray-600 mb-4 text-xs 2xl:text-sm">
          ...
          <div className="flex flex-col items-center text-center px-6">
            <Image
              ...
              className="mb-4 -mt-6"
            />
            <h3 className="text-lg 2xl:text-xl font-medium mb-2 w-40 2xl:w-52">Accelerated Research & Development</h3>
            <p className="text-gray-600 mb-4 text-xs 2xl:text-sm text-center">
