...
function Statistics() {
  return (
    <section className="bg-white py-28 2xl:py-32 max-md:py-16 max-md:flex max-md:justify-center max-md:w-full">
      <div className="container mx-auto px-6 lg:px-36 2xl:px-52 relative max-md:container max-md:px-4 max-md:mx-auto max-md:flex max-md:flex-col max-md:items-center max-md:w-full">
        {/* Background design */}
        <div className="absolute -top-16 2xl:-top-20 right-28 2xl:right-40 max-lg:-right-12 max-md:absolute max-md:-right-32 max-md:-top-16">
          <Image
        ...
        {/* Heading */}
        <div className="mb-4 max-md:mb-8 max-md:z-10 max-md:relative  max-md:w-full max-md:-ml-32 ">
        ...
        {/* Statistics Grid */}
        <div className="grid max-md:grid-cols-2 grid-cols-4 gap-8 mt-20 2xl:mt-32 max-md:gap-20 max-md:mt-12 max-md:w-[35rem] max-md:justify-items-center max-md:mx-auto max-md:-ml-20">
          {/* 90% Stat */}
