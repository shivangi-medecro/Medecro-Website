...
function Testimonials() {
  ...
  return (
    <div className="w-full -mt-48 mb-[-16rem] max-lg:-mt-48 max-lg:mb-[-16rem] relative z-10">
      <div className="mx-auto px-6 max-lg:px-0 max-sm:px-2">
        <div className="max-md:max-w-[780px] lg:max-w-[1100px] max-lg:max-w-[1000px] 2xl:max-w-[1300px] mx-auto max-sm:w-[90%] bg-white rounded-2xl shadow-md py-16 2xl:py-20 px-36 max-lg:px-20 max-md:py-8 max-sm:py-6 max-sm:px-5">
          <div className="flex max-md:flex-col justify-between items-center gap-20 max-sm:gap-10">
            {/* Left Section - Title */}
            <div className='flex flex-col justify-center items-center'>
              <p className="text-sm max-md:text-sm max-lg:text-xs 2xl:text-lg tracking-[0.25em] uppercase mb-5 max-lg:mb-3 max-sm:text-[10px] max-sm:mb-2">T E S T I M O N I A L S</p>
              
              {/* Title for desktop/tablet screens */}
              <h2 className="text-[2.5rem] max-md:hidden max-lg:text-[2rem] 2xl:text-[3rem] leading-[1.2] font-bold ">
              ...
              <h2 className="hidden max-md:block text-5xl leading-[1.2] font-bold text-center max-md:-mb-2 max-sm:text-3xl">
                <div className="text-[#231F20]">What Our <span className="text-[#0316FF]">Clients</span></div>
                <div className="text-[#231F20]">Think About Us?</div>
              </h2>
            </div>

            {/* Right Section - Content */}
            <div className="flex-1">
              <div className="flex justify-between items-center w-full mb-8 max-sm:mb-4">
                {/* Profile Images with fixed ring and comma */}
                <div className="profile-carousel relative h-14 2xl:h-16 w-[120px] 2xl:w-[138px] max-sm:h-12 max-sm:w-[100px]">
                  <div className="absolute left-0 top-0 w-14 h-14 2xl:w-16 2xl:h-16 rounded-full border-2 border-[#0316FF] z-20 pointer-events-none max-sm:w-12 max-sm:h-12"></div>
                  
                  {/* Fixed comma icon */}
                  <div className="absolute left-9 top-10 2xl:left-11 2xl:top-12 z-30 pointer-events-none max-sm:left-8 max-sm:top-8">
                    <Image
                      src="/Testimonials/comma.png"
                      alt="Quote"
                      width={18}
                      height={18}
                      className="2xl:w-[22px] 2xl:h-[22px] max-sm:w-[14px] max-sm:h-[14px]"
                      priority
                    />
                  </div>
                  ...
                  <div className="relative w-full h-full">
                    {testimonialData.map((testimonial, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-14 h-14 2xl:w-16 2xl:h-16 rounded-full overflow-hidden max-sm:w-12 max-sm:h-12">
                            <Image
                ...
                <div className="navigation-arrows flex gap-3 relative z-50 max-sm:gap-2">
                  <button 
                    onClick={handlePrev}
                  ...
                  >
                    <Image
                      ...
                      width={20}
                      height={18}
                      className="2xl:w-[24px] 2xl:h-[16px] max-sm:w-[16px] max-sm:h-[14px]"
                      style={{
                  ...
                  >
                    <Image
                      ...
                      width={20}
                      height={18}
                      className="transform rotate-180 2xl:w-[24px] 2xl:h-[16px] max-sm:w-[16px] max-sm:h-[14px]"
                      style={{
              ...
              <div className="relative overflow-hidden max-md:h-[130px] h-[155px] max-lg:h-[140px] 2xl:h-[165px] max-sm:h-[120px]">
                <div 
                ...
                >
                  ...
                  <div className="overflow-y-auto">
                    <p className="text-[#231F20] max-md:text-sm text-sm max-lg:text-xs 2xl:text-base leading-[1.6] mb-6 break-words max-sm:text-[11px] max-sm:leading-[1.5] max-sm:mb-3">
                      &quot;{testimonialData[currentIndex].quote}&quot;
                    </p>
                  </div>
                  {/* Author info - slightly increased spacing */}
                  <div>
                    <h3 className="text-[#231F20] max-md:text-sm text-sm max-lg:text-xs 2xl:text-base font-semibold max-sm:text-[11px]">
                      {testimonialData[currentIndex].name}
                    </h3>
                    <p className="text-[#231F20]/60 max-md:text-sm text-sm max-lg:text-xs 2xl:text-base max-sm:text-[10px]">
